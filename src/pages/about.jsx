    ...
    <>
      <section>
        <div className="relative flex justify-center items-center h-full w-full">
          <img src={office_1} alt="office 1" className="object-cover" />
      ...
      <section className="px-4 lg:px-10 py-10 ">
        <div className="lg:flex lg:justify-between">
          <div className="lg:w-2/4 lg:flex lg:flex-col lg:justify-center">
            ...
            <div className="font-bold text-[30px] lg:text-[32px] leading-10 tracking-[-0.5px] pt-5 pb-10 text-left align-top">
